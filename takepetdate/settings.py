"""
Django settings for takepetdate project.
...
SECRET_KEY = 'django-insecure-^c(^l5)!fv)3zjawm2$9h!yo6%s-$!k!fi1_8p7725v5lq1vrc'
...
WSGI_APPLICATION = 'takepetdate.wsgi.application'
